...
func TestDecryptionSigning(t *testing.T) {
	...
	recoveredSigner, err := RecoverDecryptionSignatureSigner(signature, batcherContractAddress, cipherBatchHash, decryptionKey, batchHash)
	require.Nil(t, err)
