...
func (att *EncryptionKeyAttestation) VerifySignature() bool {
	preimage := EncryptionKeyPreimage(att.EncryptionKey, att.BatchIndex, att.ConfigContractAddress)
...
// key attestation.
func EncryptionKeyPreimage(key []byte, batchIndex uint64, configContractAddress common.Address) []byte {
